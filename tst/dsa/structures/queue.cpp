...
#include "queue_from_vector.h"
#include "queue_from_shared_pointer.h"
#include "queue_from_c_array.h"
...
{
    // GIVEN
    unique_ptr<IQueue> q = std::make_unique<QueueFromCArray>();
    const vector<int> incoming_values{ 1, 2, 3, 4, 5 };
